...
plt.rc('font', family='serif')
plt.axis((0, 9, 0, 1.5))
plt.xlabel(r'Bunch Number', size=16)	
plt.ylabel(r'Bunch Intensity [arb. unit]', size=16)
plt.plot(x, new, '-og', label='New Splitters')
plt.plot(x, old, '-ob', label='Old Splitters' )
...
plt.savefig('splitter_improvement.jpg',bbox_inches='tight',dpi=900)
